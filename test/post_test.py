...
cookies = {
    ...
    "cookie2": "2fcdb0c05d0468655683dc72eac8fbe5",
    ...
    '_m_h5_tk': f'1e2846c022c5bd9410f9441a6bd45952_1776057518127',
    '_m_h5_tk_enc': '9278dfe59c6c099dda2259ef84645d63',
...
sign = to_md5('1e2846c022c5bd9410f9441a6bd45952' + "&" + timestamp + "&" + '34839810' + "&" + processed_data)
print(sign)
params["sign"] = sign
print(encode(data))
